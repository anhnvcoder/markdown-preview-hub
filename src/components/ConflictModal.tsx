 ...
 */
import { conflictFile, conflictDiskContent, clearConflict } from '../lib/polling';
      ...
      <div class="bg-card border border-border rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div class="p-4 space-y-4">
          <p class="text-sm text-muted-foreground">
            <strong class="text-foreground">{file.virtualName}</strong> was modified both on web and on disk.
          </p>
          ...
          <div class="space-y-2 text-sm">
            ...
            <div class="flex items-center gap-2">
              ...
              <span>Modified {file.diskLastModified ? formatTime(file.diskLastModified) : 'unknown'}</span>
            </div>
          </div>
          ...
          <div class="grid grid-cols-2 gap-2">
            <div class="p-2 bg-muted rounded text-xs">
              ...
              <pre class="truncate">{file.contentOverride?.slice(0, 100)}...</pre>
            </div>
            <div class="p-2 bg-muted rounded text-xs">
