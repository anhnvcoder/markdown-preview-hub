...
import { updateContent, saveToDisk, syncFromDisk, getContent } from '../lib/virtual-fs';
import { activeFileId, activeFileContent, updateFileInState, activeFile, refreshFiles } from '../stores/file-store';
...
export function Editor({ fileId, initialContent, onContentChange }: EditorProps) {
