      ...
      <div class='bg-card border border-border rounded-lg shadow-xl max-w-md w-full mx-4'>
        ...
        <div class='p-4 space-y-4'>
          <p class='text-sm text-muted-foreground'>
            Uploading{' '}
            {warning.type === 'folder' ? 'this folder' : 'these files'} to{' '}
            <strong class='text-foreground'>
              {warning.targetPath || 'root'}
            </strong>{' '}
          ...
          <div class='space-y-2 text-sm'>
            {warning.newFileCount > warning.existingFiles.length && (
              <div class='flex items-center gap-2'>
                ...
                <span>
                  {warning.newFileCount - warning.existingFiles.length} new
            ...
            {warning.existingFiles.length > 0 && (
              <div class='flex items-center gap-2'>
                ...
                <span>
                  {warning.existingFiles.length} existing file(s) will be
                  replaced
                </span>
              </div>
            )}
